...
#    BaseDialog()
    ...
    ModelName = stl_file_name[0:len(stl_file_name)-4]
    print 'Model name:', ModelName
    
    FileputPath = ".\\"+ModelName+"\\"
#    print FileputPath
#    print OutputPath
...
#            OutSVGFileName = stl_file_name[0:len(stl_file_name)-4]+str(2000+i).zfill(4)+".svg"
        ...
        OutSVGFileName = str(2000+i).zfill(4)+".svg"  #new add
    ...
    if GenIdx == 'True':
        ...
        idx_file = codecs.open(filename+".idx", 'w', encoding='utf-8')
